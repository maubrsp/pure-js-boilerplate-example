...
pages.forEach(function(pathname) {
    ...
    var conf = {
        ...
        //template: "?min=" + production + "!" + pathname + ".html", //html模板路径
        //template: "html-withimg-loader?min=" + production + "!" + pathname + ".ejs", //html模板路径
        template: pathname + ".ejs", //html模板路径
        //template: "!!inline-html-withimg-loader?min=" + production + "!" + pathname + ".html", //html模板路径
		/*
		*/
